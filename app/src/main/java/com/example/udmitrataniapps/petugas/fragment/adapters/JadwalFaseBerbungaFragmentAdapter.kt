...
class JadwalFaseBerbungaFragmentAdapter() : RecyclerView.Adapter<JadwalFaseBerbungaFragmentAdapter.ViewHolder> (){
    ...
    inner class ViewHolder(itemView : View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(data: JadwalMonitoring) {
            ...
            val convert = dateFormat.parse(data.fase_berbunga)!!
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): JadwalFaseBerbungaFragmentAdapter.ViewHolder {
    ...
    @RequiresApi(Build.VERSION_CODES.O)
    override fun onBindViewHolder(holder: JadwalFaseBerbungaFragmentAdapter.ViewHolder, position: Int) {
